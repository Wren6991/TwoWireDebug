...
* Is it possible for the Connect sequence to appear within regular traffic? This would break multidrop. Maybe an extra link state is needed to hold a DTM idle after connecting to a different DTM.
